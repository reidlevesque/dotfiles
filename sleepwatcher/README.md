...
# arm
ln -s ~/.dotfiles/sleepwatcher/de.bernhard-baehr.sleepwatcher-20compatibility-localuser-arm.plist ~/Library/LaunchAgents
launchctl load ~/Library/LaunchAgents/de.bernhard-baehr.sleepwatcher-20compatibility-localuser-arm.plist

# x86
ln -s ~/.dotfiles/sleepwatcher/de.bernhard-baehr.sleepwatcher-20compatibility-localuser-x86.plist ~/Library/LaunchAgents
